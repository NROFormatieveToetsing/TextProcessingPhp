...
function most_frequent_value_in_array($array)
{
    ...
    arsort($values);
    return array_slice(array_keys($values), 0, 20, true);
}
    ...
    <script language="JavaScript">
        ...
        function displayWordsInInput1() {
            var data = {
                ...
                datasets: [
                    {
                        fillColor: "rgba(220,220,220,100)",
                        strokeColor: "green",
                        pointColor: "#33A2E8",
                        pointStrokeColor: "#fff",
                        pointHighlightFill: "#fff",
        ...
        function displayWordsInInput4() {
            var data = {
                ...
                datasets: [
                    {
                        fillColor: "rgba(220,220,220,150)",
                        strokeColor: "red",
                        pointColor: "#33A2E8",
                        pointStrokeColor: "#fff",
                        pointHighlightFill: "#fff",
...
<table style="width:100%">
  <tr>
    <td align="center"><h4>Most Common Words In File 1</h3>
    <canvas id="input1" height="200" width="400" style="border: 1px solid grey; padding: 2%"></canvas></td>
    <td align="center"><h4>Most Common Words In File 2</h3>
    <canvas id="input2" height="200" width="400" style="border: 1px solid grey; padding: 2%"></canvas></td> 
   
  </tr>
  <tr>
    <td align="center"><h4>Most Common Words In Webpage</h3>
    <canvas id="input3" height="200" width="400" style="border: 1px solid grey; padding: 2%"></canvas></td>
    <td align="center"><h4>Most Common Words In Text Box</h3>
    <canvas id="input4" height="200" width="400" style="border: 1px solid grey; padding: 2%"></canvas></td> 
